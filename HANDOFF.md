# HANDOFF.md — `archive/`로 격하됨 (redirect tombstone)

> **이 파일은 redirect tombstone이다.** Phase 0 셋업기 인계 문서 `HANDOFF.md`는 phase0-cleanup(작업 B)으로 **`archive/HANDOFF.md`로 격하**됐다. 전체 본문(provenance)은 거기에 보존돼 있다. 루트에는 깨진 참조 방지용 redirect만 둔다.
>
> **현행 기준 문서 매핑:**
