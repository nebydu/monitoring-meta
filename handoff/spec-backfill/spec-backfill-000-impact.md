...
- [ ] **기존 위상 불일치 — 별도 work-id로 분리(2026-06-12 codex-gate 1·2라운드 지적 → 사람 결정: 분리)**: 후속 work-id(가칭 `open-alignment`)에서 항목별 대조·정리. 범위 두 갈래 — 모두 **v0.8부터 존재, v0.11 diff 무접촉(기계 대조 — 29 hunk 중 해당 절 0)**, 항목별 사람 결정 필요라 v0.11 "신규 결정 0" 원칙상 제외:
