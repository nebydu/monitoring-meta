...
> **[상태 갱신 — 2026-06-06]** 본 문서는 정합성 체크리스트 해소 시점(2026-06-05) 기록이다. 이후 **D-4(1)이 2026-06-06 Accepted**로 닫혀 `adr/0005`는 더 이상 Proposed가 아니다(본문의 "ADR 상태 Proposed / D-4(1) 비준 대기" 서술은 그 시점 상태). 현행 정본은 `adr/0005-topic-naming.md`·`docs/kafka-payloads.md`.
