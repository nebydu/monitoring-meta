...
>
> **입력 source of truth**: `docs/phase1/ROADMAP_PHASE1_v0_3.md` §17 D-5 / §3.1 demo-correction matrix / `docs/통합본_v0_9.md` §6.9.2(=§6.9(나), line 1742~1758) / §8.3 ADR 18개 매핑(line 2284~2303) / `handoff/decisions/phase1-critical-path-analysis.md` §5(a-1 D-5).
>
...
{
  "status": "blocked",
  "outputs": ["handoff/decisions/d5-classification-packet.md"],
  "findings": [
