...
| **기준 monitoring-meta commit** | `<full-hash>` | **필수.** 이 spec이 가리키는 기준 문서(통합본 v0.9 / envelope.md / kafka-payloads.md)의 **고정 시점**. 아래 §1.1 참조 |
| 작성일 | `YYYY-MM-DD` | |
...
<통합본 v0.9의 `[Open]`/Open question, 미결정 ADR, 데모 spec↔통합본 성격 충돌 등.
