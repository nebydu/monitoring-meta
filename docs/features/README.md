...
| [script-job-execution.md](script-job-execution.md) | 스케줄 등록 → Quartz 트리거 → command-topic → SCRIPT_JOB 실행 → result-topic-job → hub 수신·표시 | hub, script-agent, infra | `e2e/results/20260614-164044.md` PASS 64/0/0 | 검증됨 |
| [log-job-collection.md](log-job-collection.md) | 스케줄 등록 → command-topic → LOG_JOB 실행(offset 추적·tail-f 스타일) → result-topic-log → hub 수신·표시 | hub, script-agent, infra | `e2e/results/20260614-164044.md` PASS 64/0/0 | 검증됨 |
