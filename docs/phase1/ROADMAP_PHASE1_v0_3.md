...
>
> **지금 가능**
> - [작업] **T4-1** 토픽 재명명 구현(zone 단위 + 의미 기반, 규칙 B) — `adr/0005` Accepted로 BLOCKED 해제. **handoff 분배 대기**(`handoff/phase1-040-topic-naming.md`). 실행 순서 D-4(2) RESOLVED(envelope 먼저)이므로 Track 0 이후 착수. → §13
