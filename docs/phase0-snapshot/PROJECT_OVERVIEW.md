...
> **[phase0-snapshot 위상 주석 — 2026-06-05 추가]** 본 문서는 **Phase 0 데모 스냅샷**(참조 전용)이다.
> 이 디렉터리(`monitoring-meta/docs/phase0-snapshot/`)는 데모 spec v0.2.1 단일 정본
> (`monitoring-demo-message-spec-v0.2.1.md`)과 본 개요를 함께 보관한다. 데모 spec 정본은
...
> **Phase 1+ 도달 목표 / phase 귀속의 정본은 `통합본_v0_9.md` + `docs/phase1/ROADMAP_PHASE1_v0_3.md`다.**
> 본 문서의 phase 귀속 서술 중 정본과 충돌하는 부분에는 `superseded by` 표시를 달았다(본문은 보존).
...
│   ├── pom.xml
│   ├── docs/
│   │   └── monitoring-demo-message-spec-v0.2.1.md   # 데모 spec 사본(phase0-cleanup으로 삭제 예정; 정본=monitoring-meta/docs/phase0-snapshot/)
...
> Phase 0 데모 시점 서술이며 **phase 귀속의 정본이 아니다.** 특히 "본개발 Phase 2: …
> Alert / Incident"는 ROADMAP_PHASE1_v0_3 §3·§5.1·§14와 충돌한다. 정본은 **Rule Engine /
...
> phase 귀속이 필요하면 통합본 v0.9 / ROADMAP_PHASE1_v0_3을 따른다(아래 본문은 데모 시점 기록으로 보존).
...
> 원본: `monitoring-meta/docs/phase0-snapshot/monitoring-demo-message-spec-v0.2.1.md` (phase0-cleanup으로 각 repo 사본 `hub/docs/`·`script-agent/docs/`에서 단일 정본으로 이관; 사본은 삭제 예정).
...
> **[superseded by 통합본 v0.9 / ROADMAP_PHASE1_v0_3 — 2026-06-05]** 아래 phase 귀속(특히
> "Alert / Incident 도메인 = Phase 1")은 §3.1의 "본개발 Phase 2: … Alert / Incident"와
> 자체 모순이다. phase 귀속의 정본은 통합본 v0.9 / ROADMAP_PHASE1_v0_3이며, 정본은
...
- ADR/spec 정밀 검토라면: `monitoring-meta/docs/phase0-snapshot/monitoring-demo-message-spec-v0.2.1.md` (데모 spec 단일 정본)
